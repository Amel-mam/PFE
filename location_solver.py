...
st.title("Interface d'Optimisation de Localisation-Allocation")
st.write("Cette application permet de résoudre un problème de localisation de manifolds et de CPF en utilisant une heuristique de clustering, améliorée par des métaheuristiques (Recuit Simulé, Recherche Tabou).")
